  ...
  return (
    <div className='p-10 space-y-10 w-3/4 h-full flex flex-col items-center justify-center '>
      ...
      <div className='flex flex-col space-y-2 md:space-x-2 items-center md:flex md:flex-row'>
        ...
        <a className='px-5 mt-2 border-2 hover:bg-black hover:text-white py-8 border-black/10  rounded-xl font-bold text-3xl' href='https://github.com/AayushYadav2002/Color-picker'> <FaGithub /></a>
        <h2 className='text-xl py-8 hover:border-black/20 border-black/10 cursor-pointer px-5  border-2 rounded-xl'>Task - 3</h2>
